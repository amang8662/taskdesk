...
export default class SubmittedList extends Component<{}> {
  ...
  getTasks = () => {
    ...
    url = `${baseurl}/task/user/${User.get()._id}?taskstatus=2`;
  ...
  loadMoreTasks = () => {
    ...
    const {page} = this.state;
    url = `${baseurl}/task/user/${User.get()._id}?taskstatus=2&page=${page}`;
  ...
  approveTask = (taskid) => {
    ...
    NetInfo.isConnected.fetch().then((isConnected) => {
      ...
      if(isConnected) {
        ...
        timeout(10000, 
          fetch(baseurl + '/task/approve/' + taskid, {
              method : 'put',
              headers : {
                'Accept' : 'application/json',
                'Content-type' : 'application/json'
            ...
            <Card >
             ...
             <CardItem>
              ...
              <CardItem>
                ...
                <Right>
                  <Button danger onPress={() => this.approveTask(item._id)}>
                    <Text>Approve</Text>
